...
export class AddproductComponent {
  ...
  addproduct() {
    ...
    this.productDto.productTags = this.productForm
      .get('tags')
      ?.value.map((tagId: number) => ({ tagId }));
    this.productDto.features = this.productDto.features = this.productForm
      .get('features')
    ...
    this.messageService.add({
      severity: 'info',
      summary: 'Info',
      detail: 'Wait a sec Inserting Your Data',
    });
